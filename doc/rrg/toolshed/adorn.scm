...
(define (revise-until! ac-list new-kind int/mesgs #!optional end-act)
...
(define (peeking-at ac-list mesg-list)
  (and (not (null? ac-list)) (let ((ac (car ac-list)))
                               (if (memq (get-kind ac) (cons 'abbrev
                                                             atmosphere-kinds))
                                   (peeking-at (cdr ac-list) mesg-list)
                                   (memq (get-mesg ac) mesg-list)))))
;==============================================================================
          ...
          (let* ((recents (chars-until ac-list '~~rt-syntax))
            ...
            (cond ((matches-one-of? runtime-syntax tested)
                  ...
                  (else (revise-while! ac-list 'default rt-syntax?)
                        (adorn-char nc 'default #f)))))
        (cond ((memq pm '(~rt-syntax ~~rt-syntax))
