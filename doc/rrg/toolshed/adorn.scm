...
(define handle-~datumc!
  (handle-~datumc/compound! 'datumc '~datumc 'datumc-simple-begin))
...
(define (handle-datumc-simple! ac-list nc pm pac)
  ...
  (guard (match? ((not match?) #f))
    (box-ac!
     (case pm
       ...
       ((datumc-simple)            (handle-datumc-simple! ac-list nc pm pac))
       ((datumc-simple-begin)      (handle-datumc-simple! ac-list nc pm pac))
