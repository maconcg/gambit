...
(define try-string-pm!                 (^try-symm-pm! 'string))
(define try-ident-pm!                  (^try-symm-pm! 'ident))
(define try-sv-define-ident-pm!        (^try-symm-pm! 'sv-define-ident))
(define try-defun-param-ident-pm!      (^try-symm-pm! 'defun-param-ident))
(define try-defun-proc-ident-pm!       (^try-symm-pm! 'defun-proc-ident))
(define try-sv-let-ident-pm!           (^try-symm-pm! 'sv-let-ident))
(define try-named-let-ident-pm!        (^try-symm-pm! 'named-let-ident))
(define try-lambda-bind-ident-pm!      (^try-symm-pm! 'lambda-bind-ident))
(define try-lambda-rest-ident-pm!      (^try-symm-pm! 'lambda-rest-ident))
(define try-mv-let-ident-pm!           (^try-symm-pm! 'mv-let-ident))
(define try-mv-let-rest-ident-pm!      (^try-symm-pm! 'mv-let-rest-ident))
(define try-mv-define-ident-pm!        (^try-symm-pm! 'mv-define-ident))
(define try-key-bind-ident-pm!         (^try-symm-pm! 'key-bind-ident))
(define try-opt-bind-ident-pm!         (^try-symm-pm! 'opt-bind-ident))
(define try-rest-bind-ident-pm!        (^try-symm-pm! 'rest-bind-ident))
(define try-key-init-ident-pm!         (^try-symm-pm! 'key-init-ident))
(define try-opt-init-ident-pm!         (^try-symm-pm! 'opt-init-ident))
(define try-mv-define-rest-ident-pm!   (^try-symm-pm! 'mv-define-rest-ident))
(define try-case-lambda-bind-ident-pm! (^try-symm-pm! 'case-lambda-bind-ident))
(define try-defproc-proc-ident-pm!     (^try-symm-pm! 'defproc-proc-ident))
(define try-defproc-param-ident-pm!    (^try-symm-pm! 'defproc-param-ident))
(define try-defproc-spec-ident-pm!     (^try-symm-pm! 'defproc-spec-ident))
...
(define (try-symmetric-pm! ac-list nc pac pm)
  (or (try-string-pm!                 ac-list nc pac pm)
      ...
      (try-defproc-param-ident-pm!    ac-list nc pac pm)
      (try-defproc-proc-ident-pm!     ac-list nc pac pm)
      (try-defproc-spec-ident-pm!     ac-list nc pac pm)))
