...
(define ^handle~lambda/bind/rest-pm!
  (^handle~bind-pm! 'lambda-rest '~lambda-bind/rest 'lambda-rest-ident))

(define (handle~lambda-bind/rest-pm! ac-list nc pac)
  (cond ((memc nc compound-begin-chars)
         (begin-compound! ac-list nc 'lambda-bind-list))
        (else (^handle~lambda/bind/rest-pm! ac-list nc pac))))
