...
(define (main . args)
  (write-string "@comment Generated by write-macros.scm\n\n")
...
(define (write-opt-macro)
  (write-string #<<EOF
@rmacro opt {arg}
@inlinefmtifelse{html,@inlineraw{html,<span class="opt-bracket">[</span>}\arg\@inlineraw{html,<span class="opt-bracket">]</span>},[\arg\]}
@end rmacro
